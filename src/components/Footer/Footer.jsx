...
export default function Footer(){
    return(
        <footer className={style.footer_container}>
            <svg  id={style.svg}xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" className="bi bi-phone" viewBox="0 0 16 16">
            ...
            <div className={style.footer}>
                ...
                <div className={style.box}>
                    <p>Henry © 2022 | All rights reserved.</p>
                </div>
                <div className={style.box}>
                    <p>Payment Methods</p>
                </div>
